...
"""
    For passing networks we use only accurate/successful passes made by a team
    until the first substitution
"""

""" check for the index of first sub
"""
...
"""
mask_england = (df.type_name == 'Pass') & (df.team_name == "England Women's") & (df.outcome_name.isnull()) & (df.sub_type_name != 'Throw-in')
"""
